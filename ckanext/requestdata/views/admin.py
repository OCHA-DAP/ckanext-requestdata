...
#
#     organizations_for_filters = sorted(organizations_for_filters.items(), key=lambda ((x, y)): y['requests'],
#                                        reverse=True)
#
#     total_requests_counters = _get_action('requestdata_request_data_counters_get_all', {})
#     extra_vars = {
...
requestdata_ckanadmin.add_url_rule(u'/requests_data', view_func=requests_data, methods=[u'GET'])
